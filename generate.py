...
args = myArgs.Parse(
    ...
    spellcheckmode='simple', # mode for book spell checking (now only simple, complex)
    spellcheckwrongout='data/misspelledwords.txt', # where to put a summary of misspelled words
...
if args.spellcheck:
    ...
    books, set_unknown, set_known = book_spell.spellcheck(books, mode=args.spellcheckmode)
